...
Todo Ledger:
- Planned: Remove pre-save routine list assertion and make day matching case-insensitive.
- Completed: Dropped pre-save routine list check and updated day checkbox matching regex.
- Remaining: None.
Next Action: Run npm run e2e with the required env vars.

diff --git a/tests/e2e/othello.todayplanner.routines.spec.js b/tests/e2e/othello.todayplanner.routines.spec.js
new file mode 100644
index 00000000..8b8e7e77
--- /dev/null
